Name "gprog ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/projectoriginchain/go-originelladiuma/issues"
!define UPDATEURL "https://github.com/projectoriginchain/go-originelladiuma/releases"
!define ABOUTURL "https://github.com/projectoriginchain/go-originelladiuma#ethereum-go"
...
# Install gprog binary
Section "Gprog" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gprog}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gprog.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gprog.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gprog incoming peers (TCP:47380)"
  SimpleFC::AdvRemoveRule "Gprog outgoing peers (TCP:47380)"
  SimpleFC::AdvRemoveRule "Gprog UDP discovery (UDP:47380)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gprog incoming peers (TCP:47380)" ""  6 1 1 2147483647 1 "$INSTDIR\gprog.exe" "" "" "Ethereum" 47380 "" "" ""
  SimpleFC::AdvAddRule "Gprog outgoing peers (TCP:47380)" ""  6 2 1 2147483647 1 "$INSTDIR\gprog.exe" "" "" "Ethereum" "" 47380 "" ""
  SimpleFC::AdvAddRule "Gprog UDP discovery (UDP:47380)" "" 17 2 1 2147483647 1 "$INSTDIR\gprog.exe" "" "" "Ethereum" "" 47380 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gprog.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gprog.ipc"
