...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gprog.ipc", false, filepath.Join(os.TempDir(), "gprog.ipc")},
		{"data", "gprog.ipc", false, "data/gprog.ipc"},
		{"data", "./gprog.ipc", false, "./gprog.ipc"},
		{"data", "/gprog.ipc", false, "/gprog.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gprog.ipc", true, `\\.\pipe\gprog.ipc`},
		{"data", "gprog.ipc", true, `\\.\pipe\gprog.ipc`},
		{"data", `\\.\pipe\gprog.ipc`, true, `\\.\pipe\gprog.ipc`},
	}
